...
class DocumentTypeTest {
    ...
    void testDocumentTypeHasRequiredProperties(DocumentType type) {
        ...
        assertThat(type.getRootClass()).isNotNull();
    ...
    void testKafkaTopicMappings() {
        assertThat(DocumentType.TAX_INVOICE.getKafkaTopic()).isEqualTo("invoice.received.tax-invoice");
        assertThat(DocumentType.RECEIPT.getKafkaTopic()).isEqualTo("invoice.received.receipt");
        assertThat(DocumentType.INVOICE.getKafkaTopic()).isEqualTo("invoice.received.invoice");
        assertThat(DocumentType.DEBIT_CREDIT_NOTE.getKafkaTopic()).isEqualTo("invoice.received.debit-credit-note");
        assertThat(DocumentType.CANCELLATION_NOTE.getKafkaTopic()).isEqualTo("invoice.received.cancellation");
        assertThat(DocumentType.ABBREVIATED_TAX_INVOICE.getKafkaTopic()).isEqualTo("invoice.received.abbreviated");
    }
