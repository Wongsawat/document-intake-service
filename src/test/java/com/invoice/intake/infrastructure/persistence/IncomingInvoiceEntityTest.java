...
/**
 * Unit tests for IncomingInvoiceEntity JPA entity
 * Tests entity lifecycle, JPA annotations, and field mappings
 */
@DisplayName("IncomingInvoice Entity Tests")
class IncomingInvoiceEntityTest {

    private IncomingInvoiceEntity entity;

    @BeforeEach
    void setUp() {
        entity = IncomingInvoiceEntity.builder()
    ...
    void testPrePersistSetsDefaultStatus() {
        ...
        assertThat(entity.getStatus()).isEqualTo(InvoiceStatus.RECEIVED);
    }

    @Test
    @DisplayName("@PrePersist keeps existing status when set")
    void testPrePersistKeepsExistingStatus() {
        entity.setStatus(InvoiceStatus.VALIDATED);

        entity.onCreate();

        assertThat(entity.getStatus()).isEqualTo(InvoiceStatus.VALIDATED);
    }
    ...
    void testBuilderCreatesEntityWithAllFields() {
        ...
        IncomingInvoiceEntity fullEntity = IncomingInvoiceEntity.builder()
            .id(id)
        ...
        assertThat(fullEntity.getStatus()).isEqualTo(InvoiceStatus.VALIDATED);
    ...
    void testDocumentTypeEnum() {
        for (DocumentType type : DocumentType.values()) {
            IncomingInvoiceEntity testEntity = IncomingInvoiceEntity.builder()
    ...
    @Test
    @DisplayName("Entity stores InvoiceStatus enum correctly")
    ...
    void testSettersUpdateFields() {
        ...
        entity.setStatus(InvoiceStatus.INVALID);
        entity.setValidationResult(validationResult);
        ...
        assertThat(entity.getStatus()).isEqualTo(InvoiceStatus.INVALID);
    ...
    void testNoArgsConstructor() {
        IncomingInvoiceEntity emptyEntity = new IncomingInvoiceEntity();
    ...
    void testAllArgsConstructor() {
        ...
        IncomingInvoiceEntity fullEntity = new IncomingInvoiceEntity(
            id,
            "INV-2024-003",
            "<xml>full</xml>",
            "KAFKA",
        ...
        assertThat(fullEntity.getStatus()).isEqualTo(InvoiceStatus.FORWARDED);
        assertThat(fullEntity.getValidationResult()).isEqualTo(validationResult);
        assertThat(fullEntity.getReceivedAt()).isEqualTo(now);
